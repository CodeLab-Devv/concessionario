...
interface SidebarProps {
  isOpen: boolean;
  onToggle: () => void;
  currentPage: 'dashboard' | 'admin' | 'documents' | 'announcements' | 'shifts';
  onPageChange: (page: 'dashboard' | 'admin' | 'documents' | 'announcements' | 'shifts') => void;
}

...
export const NotificationBell: React.FC = () => {
  ...
  return <div className="relative z-[60]">
    ...
    {open && <>
      <button type="button" aria-label="Chiudi notifiche" className="fixed inset-0 z-[9998] cursor-default" onClick={() => setOpen(false)} />
      <div className="fixed right-2 top-[calc(env(safe-area-inset-top)+4rem)] z-[9999] w-[calc(100vw-1rem)] max-w-[390px] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl sm:right-3 md:absolute md:right-0 md:top-full md:mt-2 md:w-[390px]">
